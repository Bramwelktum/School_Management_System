...
<body>
    ...
    <h3> Add Course </h3>
        ...
        <form  method="post" action="<?php echo e(route('CourseRoute.form')); ?>" novalidate>
...
unset($__errorArgs, $__bag); ?>" name="courseName" id="courseName">
...
unset($__errorArgs, $__bag); ?>" name="duration" id="duration">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group mb-2">
                <label>Faculty</label>
                <input type="text" class="form-control <?php $__errorArgs = ['faculty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="faculty" id="faculty">
...
</html><?php /**PATH C:\xampp\htdocs\elimu_sms\resources\views/addCourse.blade.php ENDPATH**/ ?>