...
<body>
    ...
    <h3> Add Student </h3>
        ...
        <form  method="post" action="<?php echo e(route('studentRoute.form')); ?>" novalidate>
...
unset($__errorArgs, $__bag); ?>" name="firstName" id="firstName">
...
unset($__errorArgs, $__bag); ?>" name="lastName" id="lastName">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group mb-2">
                ...
                <input type="datetime-local" class="form-control <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="course" id="course">
...
unset($__errorArgs, $__bag); ?>" name="phoneNumber" id="phoneNumber">
...
</html><?php /**PATH C:\xampp\htdocs\elimu_sms\resources\views/addStudent.blade.php ENDPATH**/ ?>