...
<body>
    ...
    <h3> Add Lecturer </h3>
        ...
        <form  method="post" action="<?php echo e(route('lecRoute.form')); ?>" novalidate>
...
unset($__errorArgs, $__bag); ?>" name="fname" id="fname">
...
unset($__errorArgs, $__bag); ?>" name="lname" id="lname">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group mb-2">
                <label>Units</label>
                <textarea class="form-control <?php $__errorArgs = ['units'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="units" id="units" rows="4"></textarea>
...
</html><?php /**PATH C:\xampp\htdocs\elimu_sms\resources\views/addLecturer.blade.php ENDPATH**/ ?>